...
<script>
	...
	var PHPSESSID = 'dbcf3a2259e752f9386e365e1682109416ce9110';
		...
		<div id="createaccount-modal-content" class="modal-content">
			...
			<div id="createaccount-simple-container">
				...
				<div id="createaccount_error_msg" class="error_msg"></div>
                        ...
                        <div class="google-recaptcha-v2-container" id="59AB4568-E973-8805-CFAA-FC4E01E98411"></div>                            <script>
            ...
            var init = function (){
                ...
                if ( typeof(objLazyGoogleReCaptchaV2) !== "undefined" )
                {
                    objLazyGoogleReCaptchaV2.initInstance (
                        "59AB4568-E973-8805-CFAA-FC4E01E98411",
						...
						if (!validateEmail($('#createaccount_email').val())) {
				            ...
				            new EmailValidator( $('#createaccount_email').val(), true)
                                .setOnValidCB(function(){
                                    ...
                                    type: "POST",
                                    dataType: "json",
                                    url: "./ajax/sign_in.php?PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110",
                                    data: {
                                        'check_email' : true ,
...
<script type="text/javascript">
	...
	$( function()
	{
		objWebTorrentDownloadForm = new WebTorrentDownloadForm( 'dbcf3a2259e752f9386e365e1682109416ce9110' );
	} );
...
<script type="text/javascript">
	...
	function UploadAccessSwitch( objParentElement, objUploadAccessSwitchSettings )
	{
		...
		this.changeHideDownloadButtons = function( intHideDownloadButtons )
		{
            ...
            if ( this.strItemType == 'upload' )
            {
            	strAjax_Url = '/ajax/upload_info.php?PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110';
		...
		this.changeAccessType = function( strNewAccessType )
		{
            ...
            {
            	strAjax_Url = '/ajax/file_info.php?PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110';
...
<script type="text/javascript">
	...
	$( function()
	{
		objUploadCopyForm = new UploadCopyForm(
			false ,
			false ,
			'dbcf3a2259e752f9386e365e1682109416ce9110' ,
			{
                ...
                <div id="gallery2__content__sidebar__inner" class="gallery2__content__sidebar__inner__flex">
                    <div id="gallery2__sidebar__info">
                        ...
                        <div class="gallery2__sidebar__content">
                            ...
                            var CHAT_DATA = {
                                userId: null,
                                phpSessid: 'dbcf3a2259e752f9386e365e1682109416ce9110',
                                fullChat: false,
...
<script type="text/javascript">
    ...
    function galleryInitalize()
    {
		...
		{
			'autocomplete_url': './ajax/file_tag.php?autocomplete&PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110' ,
			...
			'onAddTag' : function(strTagName) 
			{
				...
				$.ajax({
					type: "POST",
					dataType: "json",
					url: "./ajax/file_tag.php?PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110",
					data: 
					{
						'add_file_tag': true ,
        ...
        fConfirm( 'Vai tiešām vēlaties dzēst šo failu?</br><b>"' + strFileName + '"</b>', 'Dzēst', 'Jā, dzēst!', 'Atcelt', function(r){
            ...
            {                
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "./ajax/delete_file.php?PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110",
                    data: {
    ...
    function loadSlideContent( $jqSlideElem, intFileIndex )
    {
        ...
        switch( strFileType )
        {
            ...
            case 'pdf_converted':
                            ...
                            && arrSizesInBytes[ intFileIndex ] < 104857600                        )
                    {
                        ( function()
                        {
                            ...
                            if ( bolIsFileConvertableToPdf ) 
                            {
                            	...
                            	strPdfSrc = 'https://' + arrFileHost[ intFileIndex ] + '/api/file/get_thumb_pdf.php?i=' + arrHashes[ intFileIndex ] + '&PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110&dm=' + strDateModified + '&v=102&n=' + arrDisplayNames[ intFileIndex ] + '.pdf';
                            }
                            else 
                            {
                            	strPdfSrc = 'https://' + arrFileHost[ intFileIndex ] + '/down.php?pdf=1&truemimetype=1&i=' + arrHashes[ intFileIndex ] + '&PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110&n=' + arrDisplayNames[ intFileIndex ];
                            }
                        ...
                        )
                {
                    var fnLoadIframe = function ()
                    {
                        ...
                        $( 'iframe', $jqSlideElem )
                            .attr( 'src', 'https://' + arrFileHost[ intFileIndex ] + '/down.php?i=' + arrHashes[ intFileIndex ] + '&PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110&plain_text&view&pv=1' )
                        ...
                        )
                {
                    var fnLoadCode = function ()
                    {
                        ...
                        $.ajax( {
                            type: 'GET',
                            url: 'https://' + arrFileHost[ intFileIndex ] + '/down.php?i=' + arrHashes[ intFileIndex ] + '&PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110&code_highlighter&plain_text&view&pv=1',
                            success: function ( data ) {
            ...
            case 'video':
                ...
                {
                    var strVideoSrc = 'https://' + arrFileHost[ intFileIndex ]  + '/thumb_video/' + arrHashes[ intFileIndex ] + '' + strHttpCacheKey + '.mp4?v=1708669289&PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110';
                            ...
                            )
                        {
                            ...
                            strVideoSrc = 'https://' + arrFileHost[ intFileIndex ]  + '/down.php?i=' + arrHashes[ intFileIndex ] + '&PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110&pv=1&' + strHttpCacheKey + '.mp4';
                        }
                    ...
                    {
                        var strOriginalVideoSrc = 'https://' + arrFileHost[ intFileIndex ]  + '/down.php?i=' + arrHashes[ intFileIndex ] + '&PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110&pv=1&' + strHttpCacheKey + '.mp4';
            ...
            case 'audio':
                ...
                case 'url' :
                {
                    ...
                    if ( arrFeeDownloadPrice[ intFileIndex ] == null && ! currentFolderHasFeeDownload() )
                	{
                        ...
                        $.get( 'https://'+ arrFileHost[ intFileIndex ]  + '/down.php?i=' + arrHashes[ intFileIndex ] + '&gpv=1&view=1&truemimetype=1&PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110', function( strFileContent )
                        {
                        	$( 'iframe', $jqSlideElem )
	...
	function updateFileDescription()
	{
		...
		$.ajax({
			type: "POST",
			dataType: "json",
			url: "./ajax/file_info.php?PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110",
			data: 
			{
    ...
    function modalGalleryDownloadFileBtn( strFileHash, strDownloadType="simple" )
    {
        ...
        else if ( strDownloadType == 'pdf' )
        {
            ...
            window.location = '/api/file/get_thumb_pdf.php?i=' + strFileHash + '&PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110&dm=' + strDateModified + '&v=102&n=' + arrDisplayNames[ intItemIndex ] + '.pdf';
        }
        else if ( strDownloadType == 'mp4' )
        {
        	var strDateModified = ( typeof arrDatesModified != 'undefined' ? arrDatesModified[ intItemIndex ] : ( typeof arrModDate != 'undefined' ? arrModDate[ intItemIndex ] : '' ) );
            window.location = '/thumb_video/' + strFileHash + '.mp4?PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110&dm=' + strDateModified + '&v=102&n=' + arrDisplayNames[ intItemIndex ] + '.mp4';
        }
        else if ( strDownloadType == 'jpg' )
        {
        	var strDateModified = ( typeof arrDatesModified != 'undefined' ? arrDatesModified[ intItemIndex ] : ( typeof arrModDate != 'undefined' ? arrModDate[ intItemIndex ] : '' ) );
            window.location = '/thumb_show.php?i=' + strFileHash + '&PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110&dm=' + strDateModified + '&download';
        }
    ...
    function ocrAnalyze( objButton, strModel )
    {
        ...
        $.ajax( {
            ...
            dataType: 'json',
            crossDomain: true,
            url: './ajax/image_ocr_processing.php?PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110',
            data:
            {
    ...
    function speechToText( objButton )
    {
        ...
        $.ajax( {
            ...
            dataType: 'json',
            crossDomain: true,
            url: './ajax/speech_to_text.php?PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110',
            data:
            {
                hash: strCurrentFileHash,
            },
    ...
    function objectsLabelsDetection( objButton )
    {
        ...
        $.ajax( {
            ...
            dataType: 'json',
            crossDomain: true,
            url: './ajax/object_label_detection.php?PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110',
            data:
            {
                hash: strCurrentFileHash,
            },
...
<script type="text/javascript">
	...
	function voteForFile(strHash, fnCallback) {
		...
		$.ajax({
			type: "POST",
			dataType: "json",
			url: "./ajax/vote_for_file.php?i=PHPSESSID=dbcf3a2259e752f9386e365e1682109416ce9110",
			data: {
				'vote' : true ,
				'h' : strHash
			},
...
<script type="text/javascript">
	...
	$( function()
	{
		objPosterForm = new PosterForm( 'dbcf3a2259e752f9386e365e1682109416ce9110' );
		objPosterForm.init();
	} );
