...
<script>
	...
	var PHPSESSID = '599c9157da6193137bc4854d43e22f9a45ab0751';
		...
		<div id="createaccount-modal-content" class="modal-content">
			...
			<div id="createaccount-simple-container">
				...
				<div id="createaccount_error_msg" class="error_msg"></div>
                        ...
                        <div class="google-recaptcha-v2-container" id="5CC8FCAD-D036-6C9D-A744-2DAABE56D939"></div>                            <script>
            ...
            var init = function (){
                ...
                if ( typeof(objLazyGoogleReCaptchaV2) !== "undefined" )
                {
                    objLazyGoogleReCaptchaV2.initInstance (
                        "5CC8FCAD-D036-6C9D-A744-2DAABE56D939",
						...
						if (!validateEmail($('#createaccount_email').val())) {
				            ...
				            new EmailValidator( $('#createaccount_email').val(), true)
                                .setOnValidCB(function(){
                                    ...
                                    type: "POST",
                                    dataType: "json",
                                    url: "./ajax/sign_in.php?PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751",
                                    data: {
                                        'check_email' : true ,
...
<script type="text/javascript">
	...
	$( function()
	{
		objWebTorrentDownloadForm = new WebTorrentDownloadForm( '599c9157da6193137bc4854d43e22f9a45ab0751' );
	} );
...
<script type="text/javascript">
	...
	function UploadAccessSwitch( objParentElement, objUploadAccessSwitchSettings )
	{
		...
		this.changeHideDownloadButtons = function( intHideDownloadButtons )
		{
            ...
            if ( this.strItemType == 'upload' )
            {
            	strAjax_Url = '/ajax/upload_info.php?PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751';
		...
		this.changeAccessType = function( strNewAccessType )
		{
            ...
            {
            	strAjax_Url = '/ajax/file_info.php?PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751';
...
<script type="text/javascript">
	...
	$( function()
	{
		objUploadCopyForm = new UploadCopyForm(
			false ,
			false ,
			'599c9157da6193137bc4854d43e22f9a45ab0751' ,
			{
                ...
                <div id="gallery2__content__sidebar__inner" class="gallery2__content__sidebar__inner__flex">
                    <div id="gallery2__sidebar__info">
                        ...
                        <div class="gallery2__sidebar__content">
                            ...
                            var CHAT_DATA = {
                                userId: null,
                                phpSessid: '599c9157da6193137bc4854d43e22f9a45ab0751',
                                fullChat: false,
...
<script type="text/javascript">
    ...
    function galleryInitalize()
    {
		...
		{
			'autocomplete_url': './ajax/file_tag.php?autocomplete&PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751' ,
			...
			'onAddTag' : function(strTagName) 
			{
				...
				$.ajax({
					type: "POST",
					dataType: "json",
					url: "./ajax/file_tag.php?PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751",
					data: 
					{
						'add_file_tag': true ,
        ...
        fConfirm( 'Vai tiešām vēlaties dzēst šo failu?</br><b>"' + strFileName + '"</b>', 'Dzēst', 'Jā, dzēst!', 'Atcelt', function(r){
            ...
            {                
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "./ajax/delete_file.php?PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751",
                    data: {
    ...
    function loadSlideContent( $jqSlideElem, intFileIndex )
    {
        ...
        switch( strFileType )
        {
            ...
            case 'pdf_converted':
                            ...
                            && arrSizesInBytes[ intFileIndex ] < 104857600                        )
                    {
                        ( function()
                        {
                            ...
                            if ( bolIsFileConvertableToPdf ) 
                            {
                            	...
                            	strPdfSrc = 'https://' + arrFileHost[ intFileIndex ] + '/api/file/get_thumb_pdf.php?i=' + arrHashes[ intFileIndex ] + '&PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751&dm=' + strDateModified + '&v=102&n=' + arrDisplayNames[ intFileIndex ] + '.pdf';
                            }
                            else 
                            {
                            	strPdfSrc = 'https://' + arrFileHost[ intFileIndex ] + '/down.php?pdf=1&truemimetype=1&i=' + arrHashes[ intFileIndex ] + '&PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751&n=' + arrDisplayNames[ intFileIndex ];
                            }
                        ...
                        )
                {
                    var fnLoadIframe = function ()
                    {
                        ...
                        $( 'iframe', $jqSlideElem )
                            .attr( 'src', 'https://' + arrFileHost[ intFileIndex ] + '/down.php?i=' + arrHashes[ intFileIndex ] + '&PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751&plain_text&view&pv=1' )
                        ...
                        )
                {
                    var fnLoadCode = function ()
                    {
                        ...
                        $.ajax( {
                            type: 'GET',
                            url: 'https://' + arrFileHost[ intFileIndex ] + '/down.php?i=' + arrHashes[ intFileIndex ] + '&PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751&code_highlighter&plain_text&view&pv=1',
                            success: function ( data ) {
            ...
            case 'video':
                ...
                {
                    var strVideoSrc = 'https://' + arrFileHost[ intFileIndex ]  + '/thumb_video/' + arrHashes[ intFileIndex ] + '' + strHttpCacheKey + '.mp4?v=1708669530&PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751';
                            ...
                            )
                        {
                            ...
                            strVideoSrc = 'https://' + arrFileHost[ intFileIndex ]  + '/down.php?i=' + arrHashes[ intFileIndex ] + '&PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751&pv=1&' + strHttpCacheKey + '.mp4';
                        }
                    ...
                    {
                        var strOriginalVideoSrc = 'https://' + arrFileHost[ intFileIndex ]  + '/down.php?i=' + arrHashes[ intFileIndex ] + '&PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751&pv=1&' + strHttpCacheKey + '.mp4';
            ...
            case 'audio':
                ...
                case 'url' :
                {
                    ...
                    if ( arrFeeDownloadPrice[ intFileIndex ] == null && ! currentFolderHasFeeDownload() )
                	{
                        ...
                        $.get( 'https://'+ arrFileHost[ intFileIndex ]  + '/down.php?i=' + arrHashes[ intFileIndex ] + '&gpv=1&view=1&truemimetype=1&PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751', function( strFileContent )
                        {
                        	$( 'iframe', $jqSlideElem )
	...
	function updateFileDescription()
	{
		...
		$.ajax({
			type: "POST",
			dataType: "json",
			url: "./ajax/file_info.php?PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751",
			data: 
			{
    ...
    function modalGalleryDownloadFileBtn( strFileHash, strDownloadType="simple" )
    {
        ...
        else if ( strDownloadType == 'pdf' )
        {
            ...
            window.location = '/api/file/get_thumb_pdf.php?i=' + strFileHash + '&PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751&dm=' + strDateModified + '&v=102&n=' + arrDisplayNames[ intItemIndex ] + '.pdf';
        }
        else if ( strDownloadType == 'mp4' )
        {
        	var strDateModified = ( typeof arrDatesModified != 'undefined' ? arrDatesModified[ intItemIndex ] : ( typeof arrModDate != 'undefined' ? arrModDate[ intItemIndex ] : '' ) );
            window.location = '/thumb_video/' + strFileHash + '.mp4?PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751&dm=' + strDateModified + '&v=102&n=' + arrDisplayNames[ intItemIndex ] + '.mp4';
        }
        else if ( strDownloadType == 'jpg' )
        {
        	var strDateModified = ( typeof arrDatesModified != 'undefined' ? arrDatesModified[ intItemIndex ] : ( typeof arrModDate != 'undefined' ? arrModDate[ intItemIndex ] : '' ) );
            window.location = '/thumb_show.php?i=' + strFileHash + '&PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751&dm=' + strDateModified + '&download';
        }
    ...
    function ocrAnalyze( objButton, strModel )
    {
        ...
        $.ajax( {
            ...
            dataType: 'json',
            crossDomain: true,
            url: './ajax/image_ocr_processing.php?PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751',
            data:
            {
    ...
    function speechToText( objButton )
    {
        ...
        $.ajax( {
            ...
            dataType: 'json',
            crossDomain: true,
            url: './ajax/speech_to_text.php?PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751',
            data:
            {
                hash: strCurrentFileHash,
            },
    ...
    function objectsLabelsDetection( objButton )
    {
        ...
        $.ajax( {
            ...
            dataType: 'json',
            crossDomain: true,
            url: './ajax/object_label_detection.php?PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751',
            data:
            {
                hash: strCurrentFileHash,
            },
...
<script type="text/javascript">
	...
	function voteForFile(strHash, fnCallback) {
		...
		$.ajax({
			type: "POST",
			dataType: "json",
			url: "./ajax/vote_for_file.php?i=PHPSESSID=599c9157da6193137bc4854d43e22f9a45ab0751",
			data: {
				'vote' : true ,
				'h' : strHash
			},
...
<script type="text/javascript">
	...
	$( function()
	{
		objPosterForm = new PosterForm( '599c9157da6193137bc4854d43e22f9a45ab0751' );
		objPosterForm.init();
	} );
